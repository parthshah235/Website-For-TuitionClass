...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2016 at 12:29 PM
...
(4, 'sachinmore172@gmail.com', '0162a164884f019c25ab1326bb2ce666', 'student', '2016-05-08 05:19:40', 'invalid.png'),
...
--
-- Indexes for table `chapter_detail`
--
ALTER TABLE `chapter_detail`
  ADD PRIMARY KEY (`c_id`), ADD KEY `u_id` (`u_id`);
...
ALTER TABLE `faculty_registration`
  ADD PRIMARY KEY (`f_id`), ADD UNIQUE KEY `f_email` (`f_email`);

--
-- Indexes for table `login`
--
ALTER TABLE `login`
  ADD PRIMARY KEY (`login_id`), ADD UNIQUE KEY `login_uname_3` (`login_uname`), ADD KEY `login_uname` (`login_uname`), ADD KEY `login_uname_2` (`login_uname`);

--
-- Indexes for table `mcq_detail`
--
ALTER TABLE `mcq_detail`
  ADD PRIMARY KEY (`qu_no`);

--
-- Indexes for table `q_paper`
--
ALTER TABLE `q_paper`
  ADD PRIMARY KEY (`qpaper_no`);
...
ALTER TABLE `student_registration`
  ADD PRIMARY KEY (`stu_id`), ADD UNIQUE KEY `stu_email_2` (`stu_email`), ADD KEY `stu_email` (`stu_email`), ADD KEY `stu_email_3` (`stu_email`), ADD KEY `stu_email_4` (`stu_email`);
...
ALTER TABLE `subject_detail`
  ADD PRIMARY KEY (`s_id`), ADD KEY `st_id` (`course_id`);

--
-- Indexes for table `unit_detail`
--
ALTER TABLE `unit_detail`
  ADD PRIMARY KEY (`u_id`), ADD KEY `s_id` (`s_id`);
...
--
ALTER TABLE `chapter`
  MODIFY `chapter_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `chapter_detail`
--
ALTER TABLE `chapter_detail`
  MODIFY `c_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `exam`
  MODIFY `exam_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `login`
  MODIFY `login_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `mcq_detail`
--
ALTER TABLE `mcq_detail`
  MODIFY `qu_no` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=170;
--
-- AUTO_INCREMENT for table `q_paper`
--
ALTER TABLE `q_paper`
  MODIFY `qpaper_no` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `report`
--
ALTER TABLE `report`
  MODIFY `report_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `student_registration`
  MODIFY `stu_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `subject`
--
ALTER TABLE `subject`
  MODIFY `subject_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `unit_detail`
  MODIFY `u_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
